...
Operationally, this is decomposed into seven capabilities.
...
Purpose: construct an adequate representation of the problem or system.
...
The model should expose relevant structure, not merely reproduce source language.
...
Purpose: choose between alternatives under incomplete information, competing criteria and real constraints.
...
Purpose: determine whether the result is fit for the real problem and whether it satisfies defined requirements and constraints.

Validation and verification are not the same as critique.

- **Validation:** are we solving the right problem in a fit-for-purpose way?
- **Verification:** does the solution meet specified requirements, criteria, rules and scenarios?
...
The following apply across all seven capabilities.
